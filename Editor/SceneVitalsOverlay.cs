...
namespace Meangpu
{
    ...
    public class SceneVitalsOverlay : Overlay, ITransientOverlay
    {
        ...
        {
            var visualTree = EditorUtility.LoadAssetFromPackagePath<VisualTreeAsset>("Editor/SceneVitals/SceneVitals.uxml");

            if (visualTree == null) // this mean it in project file not as package
            {
                visualTree = AssetDatabase.LoadAssetAtPath("Assets/U.MeSceneVital/Editor//SceneVitals/SceneVitals.uxml", typeof(VisualTreeAsset)) as VisualTreeAsset;
            }
